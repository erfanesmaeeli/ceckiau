...
# EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend' #for Production
# EMAIL_HOST = 'localhost'
# EMAIL_HOST_PASSWORD = 'PASSWORD'
# EMAIL_HOST_USER = 'support@ceckiau.ir'
# EMAIL_PORT = 587
# EMAIL_USE_TLS = True
...
# TINYMCE_JS_URL = STATIC_URL + 'panel/js/tinymce.min.js'
